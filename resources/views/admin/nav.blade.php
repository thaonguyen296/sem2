    ...
    <div class="header-mobile__bar">
        <div class="container-fluid">
            <div class="header-mobile-inner">
                <a class="logo" href="#">
                    <img src="{{URL::asset('img/logo.png')}}" alt="" width="110px;">
                </a>
...
<aside class="menu-sidebar d-none d-lg-block">
    <div class="logo">
        <a href="{{url('/home')}}">
            <img src="{{URL::asset('img/logo-admin.png')}}" alt="" width="110px;">
    ...
    <div class="menu-sidebar__content js-scrollbar1">
        <nav class="navbar-sidebar">
            <ul class="list-unstyled navbar__list">
                ...
                @if(Auth::user()->level_admin->level == 0 || Auth::user()->level_admin->level == 1)
                <li>
                    <a href="{{ url('/admin/list_admin') }}">
                        <i class="fas fa-user-shield"></i>List Admin</a>
                </li>
                @endif
                <li>
                    <a href="{{ url('/admin/list_user') }}">
                        <i class="fas fa-user"></i>List User</a>
                </li>
                <li>
                    <a href="{{ url('/admin/list_feedback') }}">
                        <i class="fas fa-envelope-open-text"></i>Feedback</a>
                </li>
                <li>
                    ...
                    <div class="header-button">
                        ...
                        <div class="account-wrap">
                            <div class="account-item clearfix js-item-menu">
                                <div class="image">
                                    <img src="http://res.cloudinary.com/thaocute2906/image/upload/c_fit,h_100,w_100/{{ Auth::user()->image }}.png" alt="Admin Thao" />
                                </div>
                                <div class="content">
